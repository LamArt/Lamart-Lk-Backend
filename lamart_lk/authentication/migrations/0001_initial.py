    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_level', models.PositiveIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team_lead',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='team_lead_in',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_provider_email', models.EmailField(max_length=254)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='provider_tokens',
                                           to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='teams',
            field=models.ManyToManyField(blank=True, related_name='members', to='authentication.team'),
        ),
        migrations.AddField(
            model_name='user',
